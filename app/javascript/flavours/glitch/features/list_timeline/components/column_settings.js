  ...
  render () {
    ...
    return (
      <div>
        ...
        <div className='column-settings__row'>
          <SettingToggle prefix='list_timeline' settings={settings} settingKey={['shows', 'direct']} onChange={onChange} label={<FormattedMessage id='list_timeline.column_settings.show_direct' defaultMessage='Show DMs' />} />
        </div>
